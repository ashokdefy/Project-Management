...
public class ProjectController{
	...
	public String displayPaginatedProjectTimelines(@RequestParam("timelinesPageNo") int timelinesPageNo, Model model) throws JsonProcessingException {
		...
		Page<TimelineData> projectTimelinesPage = projectService.getPaginatedTimelinesData(timelinesPageNo, timelinesPageSize);
		List<TimelineData> projectTimelines = projectTimelinesPage.getContent();
